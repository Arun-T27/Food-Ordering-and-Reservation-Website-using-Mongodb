    ...
    <div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <span className="text-[#B8860B]">Swiss Hotels</span> Experience
          </motion.h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="space-y-5">
                <p className="text-gray-200 font-montserrat leading-relaxed">
                  Experience luxury without delay—secure your spot at Swiss Hotels' Kitchen with ease. Book in advance to ensure a seat at our beautifully arranged tables and enjoy a personalized dining experience you'll never forget
                </p>
            ...
            >
              ...
              <motion.div variants={itemVariants} className="space-y-5">
                <p className="text-gray-200 font-montserrat leading-relaxed">
                  Relish the taste of Swiss Hotels effortlessly—customize your order to suit your preferences and enjoy your favorite dishes your way. Opt for pickup or get it delivered to your door in just 20 minutes, bringing the elegance of fine dining right to you
                </p>
